...
/**
 * Generated from protobuf message <code>event_store.client.streams.ReadReq.Options.FilterOptions</code>
 */
class FilterOptions extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \GRPC\EventStore\Streams\ReadReq\Options\FilterOptions\Expression $stream_identifier
     *     @type \GRPC\EventStore\Streams\ReadReq\Options\FilterOptions\Expression $event_type
     *     @type int $max
    ...
    /**
     * Generated from protobuf field <code>.event_store.client.streams.ReadReq.Options.FilterOptions.Expression stream_identifier = 1;</code>
     * @return \GRPC\EventStore\Streams\ReadReq\Options\FilterOptions\Expression|null
     */
    ...
    /**
     * Generated from protobuf field <code>.event_store.client.streams.ReadReq.Options.FilterOptions.Expression stream_identifier = 1;</code>
     * @param \GRPC\EventStore\Streams\ReadReq\Options\FilterOptions\Expression $var
     * @return $this
     */
    public function setStreamIdentifier($var)
    {
        GPBUtil::checkMessage($var, \GRPC\EventStore\Streams\ReadReq\Options\FilterOptions\Expression::class);
    ...
    /**
     * Generated from protobuf field <code>.event_store.client.streams.ReadReq.Options.FilterOptions.Expression event_type = 2;</code>
     * @return \GRPC\EventStore\Streams\ReadReq\Options\FilterOptions\Expression|null
     */

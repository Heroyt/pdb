...
class SubscriptionInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $status
     *     @type array<\GRPC\EventStore\PersistentSubscriptions\SubscriptionInfo\ConnectionInfo>|\Google\Protobuf\Internal\RepeatedField $connections
    ...
    /**
     * Generated from protobuf field <code>repeated .event_store.client.persistent_subscriptions.SubscriptionInfo.ConnectionInfo connections = 4;</code>
     * @param array<\GRPC\EventStore\PersistentSubscriptions\SubscriptionInfo\ConnectionInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setConnections($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \GRPC\EventStore\PersistentSubscriptions\SubscriptionInfo\ConnectionInfo::class);

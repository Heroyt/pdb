...
/**
 * Generated from protobuf message <code>event_store.cluster.DataChunkBulk</code>
 */
class DataChunkBulk extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>int64 subscription_position = 5;</code>
     */
    protected $subscription_position = 0;
    /**
     * Generated from protobuf field <code>bytes data_bytes = 6;</code>
     */
    protected $data_bytes = '';
    /**
     ...
     *     @type int|string $subscription_position
     *     @type string $data_bytes
     ...
     * @return int|string
     */
    public function getSubscriptionPosition()
    {
        return $this->subscription_position;
    }
     ...
     * @return $this
     */
    public function setSubscriptionPosition($var)
    {
        GPBUtil::checkInt64($var);
        $this->subscription_position = $var;
     ...
     * @return $this
     */
    public function setDataBytes($var)
    {
        GPBUtil::checkString($var, False);
        $this->data_bytes = $var;

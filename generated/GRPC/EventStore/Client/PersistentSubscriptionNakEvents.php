...
class PersistentSubscriptionNakEvents extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type array<string>|\Google\Protobuf\Internal\RepeatedField $processed_event_ids
     *     @type string $message
     *     @type int $action
     * }
     */
    ...
    {
        GPBUtil::checkEnum($var, \GRPC\EventStore\Client\PersistentSubscriptionNakEvents\NakAction::class);
        $this->action = $var;
